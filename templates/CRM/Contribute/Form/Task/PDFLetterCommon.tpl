...
<table class="form-layout-compressed">
  <tr><td class="label-left">{$form.receipt_update.label}</td><td>{$form.receipt_update.html}</td></tr>
  <tr><td class="label-left">{$form.thankyou_update.label}</td><td>{$form.thankyou_update.html}</td></tr>
  <tr><td class="label-left">{$form.group_recurring_contribution.label}</td><td>{$form.group_recurring_contribution.html}</td></tr>
</table>
...
<div class="crm-accordion-wrapper crm-accordion_title-accordion crm-accordion-closed">
    ...
    <div class="crm-accordion-body">
      <div class="crm-block crm-form-block crm-pdf-format-form-block">
		<table class="form-layout-compressed">
			<tr>
				<td class="label-left">{$form.format_id.label}</td><td>{$form.format_id.html}{help id="id-pdf-format" file="CRM/Contribute/Form/Task/PDFLetterCommon.hlp"}</td>
				<td colspan="2">&nbsp;</td>
            </tr>
			<tr>
